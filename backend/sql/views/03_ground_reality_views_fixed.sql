-- ============================================================================
-- Module 3: GROUND REALITY VIEWS (FIXED)
-- Dataset: geo-pulse-463507.geo_pulse_data
-- Purpose: Visit tracking, heatmap analytics, and ward intelligence
-- Created: 2024-12-03
-- Fixed: Removed unsupported correlated subqueries from JOIN predicates
-- ============================================================================
...
LEFT JOIN latest_ward_intelligence lwi
  ON vr.constituency_id = lwi.constituency_id
  AND vr.location_ward = lwi.ward_name
LEFT JOIN `geo-pulse-463507.geo_pulse_data.ward_intelligence` wi
  ...
  AND wi.report_date = lwi.latest_date
...
LEFT JOIN latest_ward_intelligence lwi
  ON ih.constituency_id = lwi.constituency_id
  AND ih.location_ward = lwi.ward_name
LEFT JOIN `geo-pulse-463507.geo_pulse_data.ward_intelligence` wi
